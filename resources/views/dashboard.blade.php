...
<body class="bg-gray-50">
    ...
    <script type="text/javascript">
        ...
        // Function to calculate the dynamic max value based on the data
        function getDynamicMax(data) {
            return Math.max(...data) + (Math.max(...data) * 0.1); // Add 10% buffer to the max value
        }
